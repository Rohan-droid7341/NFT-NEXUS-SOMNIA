...
const battleContractAddress = "0x6c06043ABB080111B643834ad6568D216dFAd0DD";
...
export default function BattlePage() {
  ...
  const enterBattle = async () => {
    ...
    setLoading(true);
    try {
      console.log(`Entering battle with tokenId ${tokenId} and stake ${stakeAmount} STT`);
            ...
            {isOwner ? (
                ...
                <section className="battle-section rules-section">
                    ...
                    <div className="rules-content">
                        ...
                        <ul>
                            ...
                            <li>Specify the amount of <strong>STT to stake</strong> for this battle.</li>
                            ...
                            <li>The winner receives a portion of the total staked STT pot.</li>
             ...
             <section className="battle-section winner-section">
                ...
                <div className="winner-details">
                    ...
                    <p><strong>Reward:</strong> <span>{ethers.formatEther(winnerDetails.reward || 0)} STT</span></p>
