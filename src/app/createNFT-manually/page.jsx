...
const contractAddress = "0x78cA99EaE5E66806454EfbeD6f3accd4B5dA39f2";
const PINATA_KEY = "0854d1ace655312ec20f"; // Use your key
const SECRET_API = "77300eb47d221af40acdbe0bf0d4ce23b6535022c47f57f2b09243dc95565278"; // Use your secret
...
export default function CreateNFT() {
  ...
  async function mintNFT(tokenURI, category) {
    ...
    try {
      ...
      console.log(`   Minting Fee required: ${ethers.formatEther(mintingFee)} STT`);
                    ...
                    <div className="form-section">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                className="input-field"
                                type="number"
                                placeholder="Price in STT" // Original logic used price
